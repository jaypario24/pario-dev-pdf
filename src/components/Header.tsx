              ...
              <div className="mt-3 text-center sm:mt-5">
                ...
                <div className="mt-2 space-y-4">
                  <button
                    onClick={() =>
                      window.open(
                        'https://www.pariosolutions.com.au',
                        '_blank'
                      )
                    }
                  ...
                  >
                    Need technical help from the Pario Dev team?
                    {externalIcon}
                  </button>
                  <button
                    onClick={() => window.open('https://www.pariosolutions.com.au', '_blank')}
                  ...
                  >
                    Need help by viewing our documentation?
                    {externalIcon}
                  </button>
                  <button
                    onClick={() => window.open('https://www.pariosolutions.com.au', '_blank')}
                  ...
                  >
                    Found bugs? Report them to our ticket backlog.
                    {externalIcon}
                  </button>
                </div>
              </div>
